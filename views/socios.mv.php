        ...
        <tbody>
            ...
            ?>
                <tr>
                    ...
                    <td style="text-align:center" ><a type="button" ><i style="cursor:pointer;cursor:hand;" class="icon-edit"></i><i onclick="deleteSocio(<?= $socio['socio_nro'] ?>, 'socio');" style="cursor:pointer;cursor:hand;" class="icon-remove"></i></a></td>
                </tr>
            <?php
            }
} else {
